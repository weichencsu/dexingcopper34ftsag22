...
def serieschart_plot(df):
    ...
    fig2.add_trace(
        go.Scatter(x=df["日期"], y=df["#35排传感器"],
                   ...
                   name="#35 Row Sensor Current Thickness - [mm]"
                   )
    )
    ...
    fig2.add_trace(
        go.Scatter(x=df["日期"], y=df["#37排传感器"],
                   ...
                   name="#37 Row Sensor Current Thickness - [mm]"
                   )
    )
...
def main():
    ...
    with top:
        ...
        with colll1:
            ...
            st.header("Dashan Mine - 34FT SAG Mill")
    ...
    with col1:
        st.subheader("#35 Row Shell Liner Wear Sensor Reading")
    ...
    HtmlFile_tSS1 = open("DEXING34FTSAG.html", 'r', encoding='utf-8').read()
    components.html(HtmlFile_tSS1, height=1200)
